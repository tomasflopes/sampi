...
export default function FirstStep({ navigation }) {
  ...
  const nPlayersArray = ['3 x 3', '4 x 4', '5 x 5', '6 x 6', '7 x 7'];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.teamFormationMode}>
        ...
        >
          <View
            style={
              selected === 0
                ? styles.teamFormationModeTextContainerActive
                : styles.teamFormationModeTextContainer
            }
          >
            <Text style={styles.teamFormationModeHeaderText}>RANDOM</Text>
          </View>
          <Text style={styles.teamFormationModeText}>
            On this mode the team selection will be completely random.
          </Text>
        </TouchableOpacity>

        <TouchableOpacity
          style={[
            styles.teamFormationModeButton,
            { opacity: 0.4, backgroundColor: '#ccc' },
          ]}
        >
          <View
            style={
          ...
          <Text style={[styles.teamFormationModeText, { marginTop: 1 }]}>
            On this mode the teams will be picked by two captains, randomly
            picked by the app.
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.helpTextContainer}>
        ...
        <Text style={styles.helpText}>
          This is the mode that the teams will be selected.
        </Text>
      </View>
      ...
      <TouchableOpacity style={styles.nextStepButton} onPress={handleNextClick}>
